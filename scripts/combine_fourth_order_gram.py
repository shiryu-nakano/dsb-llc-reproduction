"""
combine_fourth_order_gram.py

moment_data/deletion/fourth_order_gram/_partial/class{0..9}.npz を1本に結合し、
moment_data/deletion/fourth_order_gram/fourth_order_cifar10.npz に保存する。
"""
import sys
...
BASE = Path("/home/nakano/server/moment_data/deletion/fourth_order_gram")
PARTIAL_DIR = BASE / "_partial"
OUT_PATH = BASE / "fourth_order_cifar10.npz"
...
def main():
    ...
    print(f"\nSaved combined fourth_order (Gram, weight=100/100) data to {OUT_PATH}")
